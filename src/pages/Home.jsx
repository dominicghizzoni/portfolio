...
const Home = () => {
  ...
  const projectData = {
    ...
    2: {
      ...
      stack: "C++ • Graph Theory • Complexity Analysis",
      github: "",
      angle: STEP * 2,
    },
    ...
    3: {
      ...
      github: "https://github.com/dominicghizzoni",
      angle: STEP * 3,
    },
    ...
    5: {
      ...
      github: "https://github.com/dominicghizzoni/daybeats",
      angle: STEP * 5,
    },
  ...
  const nextProject = () => {
    setCurrentProject((prev) => {
      ...
      setTargetRotation(projectData[nextId].angle);
  ...
  const previousProject = () => {
    setCurrentProject((prev) => {
      ...
      setTargetRotation(projectData[previousId].angle);
  ...
  return (
    <>
      ...
      <section className="w-full min-h-[75vh] flex items-center justify-center bg-black text-white px-6 pt-10">
        <div className="flex flex-col items-center text-center max-w-2xl">
          ...
          <p className="text-xl text-gray-300 mb-6">
            Computer Science M.S. Student focused on distributed systems, scalable full-stack applications, and applied machine learning systems.
          </p>
          ...
          <p className="text-xl text-gray-300 mt-20">
            ...
            Drag to look around the gallery or use the arrows.
          </p>
        </div>
      </section>
      ...
      <section className="w-full h-screen relative bg-black overflow-hidden">
        ...
        <div className="absolute left-6 top-1/2 -translate-y-1/2 z-20 hidden lg:block">
          <div className="w-80 bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-6 text-white shadow-2xl">
            ...
            <a
              href={projectData[currentProject]?.github}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <div className="flex items-center justify-between mt-8">
              <button
                ...
                className="flex items-center justify-center w-12 h-12 rounded-full border border-white/20 hover:bg-white hover:text-black transition"
              >
                <ChevronLeft size={24} />
              </button>
        ...
        <div className="absolute right-6 top-1/2 -translate-y-1/2 z-20 hidden lg:block">
          <div className="w-72 bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-6 text-white shadow-2xl">
            <h3 className="text-xl font-semibold mb-4">
              Gallery Controls
            </h3>

            <ul className="space-y-3 text-gray-300">
              <li>• Drag horizontally to look around</li>
              <li>• Camera snaps automatically</li>
              <li>• Click arrows to browse</li>
              <li>• Center project becomes active</li>
            </ul>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 lg:hidden w-[90%]">
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-5 text-white shadow-2xl">
